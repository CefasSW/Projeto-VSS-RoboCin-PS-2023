...
#include "../../../src/AbstractModules/Processing/Processing.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSProcessingENDCLASS_t qt_meta_stringdata_CLASSProcessingENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 11),  // "sendCommand"
        QT_MOC_LITERAL(23, 0),  // ""
...
Q_CONSTINIT const QMetaObject Processing::staticMetaObject = { {
    QMetaObject::SuperData::link<IndexedModuleBase::staticMetaObject>(),
...
void Processing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendCommand((*reinterpret_cast< std::add_pointer_t<Command>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Processing::*)(const Command & );
            if (_t _q_method = &Processing::sendCommand; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Processing::qt_metacast(const char *_clname)
{
    ...
    return IndexedModuleBase::qt_metacast(_clname);
}

int Processing::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = IndexedModuleBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
...
// SIGNAL 0
void Processing::sendCommand(const Command & _t1)
{
