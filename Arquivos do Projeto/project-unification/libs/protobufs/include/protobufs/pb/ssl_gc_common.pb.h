...
PROTOBUF_NAMESPACE_OPEN
template<> ::RoboCupSSL::RobotId* Arena::CreateMaybeMessage<::RoboCupSSL::RobotId>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace RoboCupSSL {
...
class RobotId PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:RoboCupSSL.RobotId) */ {
 public:
  ...
  public:
  void clear_team();
  ::RoboCupSSL::Team team() const;
  void set_team(::RoboCupSSL::Team value);
  private:
  ::RoboCupSSL::Team _internal_team() const;
  void _internal_set_team(::RoboCupSSL::Team value);
  public:

  // @@protoc_insertion_point(class_scope:RoboCupSSL.RobotId)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RobotId::id() const {
  // @@protoc_insertion_point(field_get:RoboCupSSL.RobotId.id)
  return _internal_id();
}
...
inline void RobotId::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:RoboCupSSL.RobotId.id)
}
...
inline ::RoboCupSSL::Team RobotId::_internal_team() const {
  return static_cast< ::RoboCupSSL::Team >(team_);
}
inline ::RoboCupSSL::Team RobotId::team() const {
  // @@protoc_insertion_point(field_get:RoboCupSSL.RobotId.team)
  return _internal_team();
}
inline void RobotId::_internal_set_team(::RoboCupSSL::Team value) {
  assert(::RoboCupSSL::Team_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  team_ = value;
}
inline void RobotId::set_team(::RoboCupSSL::Team value) {
  _internal_set_team(value);
  // @@protoc_insertion_point(field_set:RoboCupSSL.RobotId.team)
}
...
template <> struct is_proto_enum< ::RoboCupSSL::Team> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::RoboCupSSL::Team>() {
  return ::RoboCupSSL::Team_descriptor();
}
template <> struct is_proto_enum< ::RoboCupSSL::Division> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::RoboCupSSL::Division>() {
  return ::RoboCupSSL::Division_descriptor();
}
